...
/*At line 419 you have to change my name(raghav......) to yours*/
...
<body style="background-color:#fafad2">
    <div align=center> <img id="camstream" src="" style='width:600px;'></div>
    <br />
    <br />
    <div align=center>
        <button class="button" id="forward" ontouchstart="fetch(document.location.origin+'/control?var=car&val=1');"
            ontouchend="fetch(document.location.origin+'/control?var=car&val=3');"><b>Forward</b></button>
    </div>
    <br />
    <div align=center>
        <button class="button" id="turnleft" ontouchstart="fetch(document.location.origin+'/control?var=car&val=2');"
            ontouchend="fetch(document.location.origin+'/control?var=car&val=3');"><b>Turn Left</b></button>

        <button class="button place" id="turnright" ontouchstart="fetch(document.location.origin+'/control?var=car&val=4');"
            ontouchend="fetch(document.location.origin+'/control?var=car&val=3');"><b>Turn Right</b></button>
    </div>
    <br />
    <div align=center>
        <button class="button" id="backward" ontouchstart="fetch(document.location.origin+'/control?var=car&val=5');"
            ontouchend="fetch(document.location.origin+'/control?var=car&val=3');"><b>Backward</b></button>
    </div>
    <br />
    <div align=center>
        <label class="label"><b>Flash</b></label>
    ...
    <br />
    <div align=center>
        <label class="label"><b>Speed</b></label>
    ...
    <br />
    <div align=center>
        <button class="button" id="tiltup"
            onclick="fetch(document.location.origin+'/control?var=pantilt&val=1');"><b>Look Up</b></button>
    </div>
    <div align=center>
        <button class="button " id="panleft"
            onclick="fetch(document.location.origin+'/control?var=pantilt&val=2');"><b>Look Left</b></button>
        <button class="button place" id="panright"
            onclick="fetch(document.location.origin+'/control?var=pantilt&val=3');"><b>Look Right</b></button>
    </div>
    <div align=center>
        <button class="button" id="tiltdown"
            onclick="fetch(document.location.origin+'/control?var=pantilt&val=4');"><b>Look Down</b></button>
    </div>
    <script>
